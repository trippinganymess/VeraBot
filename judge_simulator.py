...
LLM_API_KEY = "AIzaSyAp4zTFKf-QYcbJQtcdRoTSmURx-hjdhSA"# <-- PUT YOUR API KEY HERE

LLM_MODEL = "gemini-3.1-flash-lite-preview"  # <-- Optional: specify model or leave empty for default
